        ...
        <div className="flex flex-row items-center mt-3 md:mt-4 gap-2">
          ...
          {data?.id ? (
            <button
              ...
              className="bg-white bg-opacity-40 text-white px-2 md:px-4 py-1 md:py-2 rounded-md text-xs lg:text-lg font-semibold hover:bg-opacity-20 transition flex flex-row items-center"
            >
